...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class TraceRpcModuleTests
    {
        ...
        public async Task Trace_call_without_blockParameter_test2()
        {
            ...
            Assert.AreEqual("{\"jsonrpc\":\"2.0\",\"result\":{\"output\":\"0x\",\"stateDiff\":null,\"trace\":[{\"action\":{\"callType\":\"call\",\"from\":\"0xf11f757fc1edf9b12fda4fbbf3c14d228126692b\",\"gas\":\"0x2fa9e78\",\"input\":\"0x\",\"to\":\"0xdac17f958d2ee523a2206206994597c13d831ec7\",\"value\":\"0x0\"},\"result\":{\"gasUsed\":\"0x5208\",\"output\":\"0x\"},\"subtraces\":0,\"traceAddress\":[],\"type\":\"call\"}],\"vmTrace\":null},\"id\":67}", serialized, serialized.Replace("\"", "\\\""));
        }
        
        
        [Test]
        public async Task Trace_call_without_blockParameter_test3()
        {
            Context context = new();
            await context.Build();
            string request = "{\"from\":\"0xf11f757fc1edf9b12fda4fbbf3c14d228126692b\",\"to\": \"0xdac17f958d2ee523a2206206994597c13d831ec7\",\"value\":\"0x0\",\"gasPrice\":\"0xd01009f1f\"}";
        ...
        [Test]
        public async Task Trace_call_without_blockParameter_test22()
        {
            Context context = new();
            await context.Build();
            string request = "{\"from\":\"0x7f554713be84160fdf0178cc8df86f5aabd33397\",\"to\":\"0xbe5c953dd0ddb0ce033a98f36c981f1b74d3b33f\",\"value\":\"0x0\",\"gasPrice\":\"0x119e04a40a\"}";
            string request2 = "[\"trace\"]";
            string request3 = "latest";
            string serialized = RpcTest.TestSerializedRequest(
                EthModuleFactory.Converters.Union(TraceModuleFactory.Converters).ToList(), context.TraceRpcModule,
        ...
        [Test]
        public async Task Trace_call_without_blockParameter_test333()
        {
            Context context = new();
            await context.Build();
            string request = "{\"from\":\"0xc71acc7863f3bc7347b24c3b835643bd89d4d161\",\"to\":\"0xa760e26aa76747020171fcf8bda108dfde8eb930\",\"value\":\"0x0\",\"gasPrice\":\"0x2108eea5bc\"}";
            string request2 = "[\"trace\"]";
            string request3 = "latest";
            string serialized = RpcTest.TestSerializedRequest(
                EthModuleFactory.Converters.Union(TraceModuleFactory.Converters).ToList(), context.TraceRpcModule,
            ...
            Assert.AreEqual(
                "{\"jsonrpc\":\"2.0\",\"result\":{\"output\":\"0x\",\"stateDiff\":null,\"trace\":[{\"action\":{\"callType\":\"call\",\"from\":\"0xc71acc7863f3bc7347b24c3b835643bd89d4d161\",\"gas\":\"0x2fa9e78\",\"input\":\"0x\",\"to\":\"0xa760e26aa76747020171fcf8bda108dfde8eb930\",\"value\":\"0x0\"},\"result\":{\"gasUsed\":\"0x5208\",\"output\":\"0x\"},\"subtraces\":0,\"traceAddress\":[],\"type\":\"call\"}],\"vmTrace\":null},\"id\":67}", serialized, serialized.Replace("\"", "\\\""));
        }
